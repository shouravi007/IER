...
'		   	response.Write("<br>strFirstName"+strEmail)
'		   	response.Write("<br>strContactPhone"+strContactPhone)
'		   	response.Write("<br>dtmDateYear"+dtmDateYear)
...
if strEmail <> "" and strContactPhone <> "" and dtmDateYear <> "S" then 
		...
		If Request.ServerVariables("REMOTE_ADDR") = "163.53.150.122" or Request.ServerVariables("REMOTE_ADDR") = "180.92.229.66" Or Request.ServerVariables("REMOTE_ADDR") = "163.53.150.123" Or Request.ServerVariables("REMOTE_ADDR") = "163.53.150.118" Or Request.ServerVariables("SERVER_NAME") =  "server-ers" or Session("USERNAME") = "mahbub" and Session("PWORD") = "UvWggXv6" or Request.Cookies("PWORD") = "UvWggXv6"  Then 
