...
If  arrPersonal(0,0) <> "Nothing" Then
	For i = 0  To  Ubound(arrPersonal,2) 
		...
		Next
	strMessage1 = strMessage1 & "<div class='row job-list-row hidden-xs'><div class='col-sm-4'><h3 class='title'>Grand Total</h3></div><div class='col-sm-6'><h3 class='title'>" & varSO & "</h3></div><div class='col-sm-2'><h3 class='title'><span title='Management Trainee Officer'>" & varTotal & "</span></h3></div></div></div></div></div>" 
End If 
%>
...
<%
sql = ""
sql = "exec USP_Daily_Apply_Update  3, '2019-07-31 23:59:59.000', '2019-07-01', '2019-07-16 14:00:00.000'"
ValuePrint sql , "sql"
