...
SQLPayment = "SELECT convert(date, PMNTTIME) as PaymentDate, COUNT(JRID) AS TOTAL FROM [CheckPmntStatus] Where PMNTTIME>'09/27/2019' GROUP BY convert(date , PMNTTIME)"
...
If  arrPersonal(0,0) <> "Nothing" Then
	...
	strMessage1 = "<div class='col-sm-12'><div class='date-wise-resume bg-style'><h1 class='post-name'>Total resume</h1><div class='wrapper'><div class='row job-list-row hidden-xs'><div class='col-sm-2'><h3 class='title'>Day</h3></div><div class='col-sm-4'><h3 class='title'>Application Date</h3></div><div class='col-sm-2'><h3 class='title'><span title='Assistant Officer(General)'>Assistant Officer(General)</span></h3></div><div class='col-sm-2'><h3 class='title'><span title='Assistant Officer(Cash)'>Assistant Officer(Cash)</span></h3></div><div class='col-sm-2'><h3 class='title'>Total Apply</h3></div><div class='col-sm-2'><h3 class='title'><span title='Payment Date'>Payment Date</span></h3></div><div class='col-sm-2'><h3 class='title'><span title='Total Payment'>Total Payment</span></h3></div></div><hr class='first-hr'>"
...
' Response.Write("<br/>Array: " & Ubound(arrPersonal,2)) 
	For i = 0  To  Ubound(arrPersonal,2) 
		...
		strMessage1  = strMessage1 & " <div class='col-sm-4'><h4 class='date-Wise-data'>" & FormatDateTime(arrPersonal(0, i), vbLongDate) & "</h4></div>"
		...
		varTotal =  arrPersonal(1, i) +  arrPersonal(2, i)
	
	Next
	
	strMessage1 = strMessage1 &" <div class='row job-list-row hidden-xs'><div class='col-sm-4'><h3 class='title'>Grand Total</h3></div>"
