...
<%
					If strJobPosting <> "S" Then
						  ...
						  End If
%>					
						<input type="checkbox" name="chkShortListed" id="chkShortListed<%=i+1%>" value="<%=intTrakingNumber%>" <%=checked%> />
...
<%
					If strJobPosting <> "S" Then
						RejectedValue = Request.Form("ddlRejected")
%>						
 ...
 <input type="button" name="btnSubmit" id="btnSubmit" value="<%If strCVType = "Shortlisted" Then%>Un <%End If%>Shortlist" onclick="ShortList('<%=strCVType%>', '<%=strJobPosting%>');" style="width:55px; font-family:Verdana; font-size:9px;" />
 	<input type="button" name="btnReject" id="btnReject" value="<%If RejectedValue = "1" Then%>Un <%End If%>Reject" onclick="Reject('<%=strCVType%>', '<%=strJobPosting%>', '<%=RejectedValue%>');" style="width:40px; font-family:Verdana; font-size:9px;" />
...
<%
 If Request.ServerVariables("REMOTE_ADDR") = "123.49.57.236" Then 
%>
	<input type="button" name="btnEmail" id="btnEmail" value="Email" onclick="Email();" style="width:40px; font-family:Verdana; font-size:9px;" />

	<input type="button" name="btnDelete" id="btnDelete" value="Delete" onclick="Delete('<%=strCVType%>', '<%=strJobPosting%>');" style="width:40px; font-family:Verdana; font-size:9px;" />
<% 
 End If 
%>    
