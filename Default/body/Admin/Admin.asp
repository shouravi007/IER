...
<%Elseif cstr(strFormAction) = cstr("EmailSend_Continue") then %> 
<!--#include virtual = '/applications/common/email/EmailSend_Continue.asp'--> 

<%Elseif cstr(strFormAction) = cstr("EmailSend_Processing") then 
	Session.Abandon()
%> 
<!--#include virtual = '/applications/common/email/EmailSend_Processing.asp'-->   

<%Elseif cstr(strFormAction) = cstr("EmailSend") then %> 
<!--#include virtual = '/applications/common/email/EmailSend.asp'-->
