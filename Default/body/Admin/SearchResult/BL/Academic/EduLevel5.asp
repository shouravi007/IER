	...
	If intEducationLevel(5) <> "" Then
		...
		Else
		    If intEducationLevel(4) <> "" and intEducationLevel(5) <> "" then
		  	  SQLWhere = SQLWhere & "  Or E.PERSONALID IN (Select ED.PERSONALID from ACADEMIC ED WHERE ED.EDUCATIONID=" & intEducationLevel(5) 
			Else
...
'******************RESULT4 END************************
		...
		'Else
		If intEducationLevel(4) <> "" and intEducationLevel(5) <> "" then
		   SQLWhere = SQLWhere & lastBrac & lastBrac & lastBrac
		Else
