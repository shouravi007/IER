...
<br /><br />
<button type="button" class="btn-style" style="font-size:14px;" class="view-more" role="button" data-toggle="collapse" href="#collapseNotice" aria-expanded="false" aria-controls="collapseNotice" >Even More..<i class="fa fa-chevron-down"></i></button>
</div>
