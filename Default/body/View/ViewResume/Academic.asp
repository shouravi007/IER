...
SQLAcademic = "SELECT id, DegreeName, Institute, Subject, PassingYear, EducationId, University, Result, ResultPoint, UniversityType,subject2,[AcademicDistrict] FROM Academic WHERE PersonalId=" & intTrackingNo &" ORDER BY EducationId DESC, id ASC"
