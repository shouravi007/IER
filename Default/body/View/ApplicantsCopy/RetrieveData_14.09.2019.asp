...
End If	
	...
	If arrAcademic(0, 0) <> "Nothing" Then
		...
		SSC_Examination = arrAcademic(1, 0)
		HSC_Examination = arrAcademic(1, 1)
		Graduation_Examination = arrAcademic(1, 2)
		PostGraduation_Examination = arrAcademic(1, 3)
	

		SSC_University = arrAcademic(6, 0)
		HSC_University = arrAcademic(6, 1)
		Graduation_University = arrAcademic(6, 2)
		PostGraduation_University = arrAcademic(6, 3)

		
		SSC_Subject = arrAcademic(3, 0)
		HSC_Subject = arrAcademic(3, 1)
		Graduation_Subject = arrAcademic(3, 2)
		PostGraduation_Subject = arrAcademic(3, 3)

		SSC_Year_of_passing = arrAcademic(4, 0)
		HSC_Year_of_passing = arrAcademic(4, 1)
		Graduation_Year_of_passing = arrAcademic(4, 2)
		PostGraduation_Year_of_passing = arrAcademic(4, 3)


		SSC_Division_Class = arrAcademic(7, 0)
		HSC_Division_Class = arrAcademic(7, 1)
		Graduation_Division_Class = arrAcademic(7, 2)
		PostGraduation_Division_Class = arrAcademic(7, 3)



		
		SSC_GPA_CGPA = arrAcademic(8, 0)
		HSC_GPA_CGPA = arrAcademic(8, 1)
		Graduation_GPA_CGPA = arrAcademic(8, 2)
		PostGraduation_GPA_CGPA = arrAcademic(8, 3)
		
		
		SSC_Out_of = arrAcademic(10, 0)
		HSC_Out_of = arrAcademic(10, 1)
		Graduation_Out_of = arrAcademic(10, 2)
		PostGraduation_Out_of = arrAcademic(10, 3)
