...
<div class="col-sm-12">
    ...
    <div class="wrapper">
                ...
                <!--#include virtual = '/applications/common/controller/AfterLogin/Validation.asp'-->                
                    ...
                    <fieldset>
                        ...
                        <div class="row vertical-align-items">
                         ...
                         <div class="col-sm-8 item-1">
                            ...
                            <div class="form-group"><h4>Login ID : <%=TrackNoNew%></h4></div>
...
%>
                                <!--    <span style="font-family:Verdana, Geneva, sans-serif; color:#00C;">You can edit your resume after 24<sup>th</sup> January, 2019. </span>-->
<%
End If
%>
...
<div class="row">
    <div class="deshboard-wrap bg-style">							
        ...
        <div class="row">
         ...
         <%'If cint(Apply) < 1 then %>
         
           <!-- <a id="jobApply" class="box-wrap" title="Job Apply" onclick="MyFunction();return false;">
                <i class="fa fa-list icon" aria-hidden="true"></i>
                <h3 class="title">Job Change To <%'=strMsgApply%></h3>
            </a>
            
            <a id="jobApply" class="box-wrap" title="Job Apply" onclick="MyFunction2();return false;">
                <i class="fa fa-list icon" aria-hidden="true"></i>
                <h3 class="title">Job Change To <%'=strMsgApply2%></h3>
            </a>-->            
         ...
         <%'End IF %>
                ...
                <a id="ChangeSignature" class="box-wrap" title="ChangeSignature" onclick="document.getElementById('formSignature').submit();return false;">
                    <i class="fa fa-file-photo-o icon" aria-hidden="true"></i>
                    <h3 class="title">Change Signature</h3>
                </a>                        
...
%>                
              ...
              <%if system = "ksb" then%>
                <a id="Applicants Copy" target="_blank" class="box-wrap" title="Applicants Copy" onclick="document.getElementById('form6').submit();return false;">
                    <i class="fa fa-paperclip icon" aria-hidden="true"></i>
                    <h3 class="title">Applicants Copy</h3>
                </a>          
               <%end if%>
