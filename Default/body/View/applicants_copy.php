...
$PDFData = <<<EOF
    ...
    <div class="c-wrapper">
        ...
        <table class="cont">
          <tr>
            <td class=" w-twe-p">
            	<div class="img-wrapper"><img src="http: //ers.bdjobs.com/applications/common/logo/applicantscopy
/501231935h4d5g.jpg"/></div>
            </td>
            <td class="w-eig-p">
      ...
      <table class="acaquali">
        ...
        <table class="aggapli">
          ...
          <tr>
          	<td>
            	<div class="i-wrapper">
                	<img src="http: //ers.bdjobs.com/applications/common/logo/applicantscopy
/signature.png">
...
$stylesheet = file_get_contents('css_mmbl.css');
