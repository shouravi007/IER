...
'ValuePrint strJobids , "strJobids-3" 
	...
	if strJobids = 2 or strJobids = "2" Then ' checking for JO Only
		...
		If arr_sqlCheckElg(0,0) = "Nothing" Then
			...
			ShowValidateMsg("Your Application for Junior Officer (JO) will be rejected if you change this result.<br />Click <a style='color:#F00;' href='#' onclick='javascript:PageSubmit();return false;'>here</a> to retry.</strong></font></center>")
