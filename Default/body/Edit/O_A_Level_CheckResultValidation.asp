...
<%			
            If strDegreeName = "O Level" Then			
				...
				Else
					...
					If strResultPoint < 2.81 then ' 5								 	
					
					strResultPoint = CheckValidation("True",strResultPoint,"text","Number","5","CGPA/Marks of O Level of Academic Qualification")
					
					MarksTypeInputValidationForSecandary "True",strResult,strResultPoint,5,"CGPA/Marks of O Level of Academic Qualification",jobid,2.81
		...
		ELSE
			...
			End If
				...
				If strResultPoint < 2.81 then ' 5								 	
					...
					strResultPoint = CheckValidation("True",strResultPoint,"text","Number","5","CGPA/Marks of A Level of Academic Qualification")
					
					MarksTypeInputValidationForSecandary "True",strResult,strResultPoint,5,"CGPA/Marks of A Level of Academic Qualification",jobid,2.81
