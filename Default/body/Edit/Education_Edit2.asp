...
%>          
                     ...
                     <h4 class="modal-title" id="myModalLabel">Edit Form Academic Profile &nbsp;<%=noEducation%></h4>
                  </div>
      ...
      <form <%=form_details%>>
                     ...
                     <div class="row">
					  ...
					  <select name="EDULEVEL1" id="EDULEVEL1" class="<%=frmcon%>" style="float:left;">
