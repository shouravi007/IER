...
'						  End If 		
			...
			'response.Write(resultIndex & "<BR>::: "&FirstClass)
			'response.End()
		   ...
		   If strEligibleOk = 0 Then 
			 ShowValidateMsg("Sorry , you are not eligible for this position, because you have not at least one first division marks/ equivalent cgpa.<br />Click <a   style='color:#F00;' href='#' onclick='javascript:PageSubmit();return false;'>here</a> to retry.</strong></font></center>")
		   End IF 
