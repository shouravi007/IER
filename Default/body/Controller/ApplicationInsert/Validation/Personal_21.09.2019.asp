<%
	...
	strFirstName = CheckValidation("True",strFirstName,"text","Text","40","Applicant's Name")	
...
'    end if 
	...
	strEmail = CheckValidation("True",strEmail,"text","Text","50","Email")	
	strEmail = CheckValidation("True",strEmail,"email","Text","50","Email")	
