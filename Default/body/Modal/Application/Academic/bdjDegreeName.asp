...
<option value='Fazil' <%If InStr(lcase(strDegreeName3),"fazil") > 0  Then%>  selected="selected" <%End If%>>Fazil</option>
                   ...
                   <%'End If%>
                    ...
                    <option value='L.L.M' <%If InStr(lcase(strDegreeName4),"llm") > 0 Then%>  selected="selected" <%End If%>>LLM</option>     
                    ...
                    <option value='L.L.M' <%If InStr(lcase(strDegreeName5),"llm") > 0 Then%> selected="selected" <%End If%>>LLM</option>     
...
<span id="ddlDegreeName<%=i%>_message" style="font-weight: bold; color: rgb(255, 102, 102); display: none;" class="msg"></span>
