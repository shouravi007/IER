...
%>
  ...
  <div class="col-sm-8">
       ...
       <option value="S" selected="selected">Select</option>
           ...
           <span id="ddlSubject2<%=i%>_message" style="font-weight: bold; color: rgb(255, 102, 102); display: none;" class="msg"></span>

           </div>
	              
            <div style="<%if subject_others2 = true or subject_others2 = 1 or subject_others2 = "1" then%>display:block<%Else%>display:none;<%End If%>" id="spnOthers2<%=i%>">	<input class="form-control input-sm" name='txtOthers2<%=i%>' type='text' id='txtOthers2<%=i%>' value="<%=strOthers2%>" placeholder="type here major 2" />
            <span id="txtOthers2<%=i%>_message" style="font-weight: bold; color: rgb(255, 102, 102); display: none;" class="msg"></span>
