...
%>
  ...
  <div class="col-sm-8">
        <div class="form-group">
             <div id="spnSubject<%=i%>">
               ...
               <option value="S" selected="selected">Select</option>
                  ...
                  <span id="ddlSubject<%=i%>_message" style="font-weight: bold; color: rgb(255, 102, 102); display: none;" class="msg"></span>
        ...
        <span id="txtOthers<%=i%>_message" style="font-weight: bold; color: rgb(255, 102, 102); display: none;" class="msg"></span>
