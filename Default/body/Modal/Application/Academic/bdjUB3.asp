<%   If bdjAcademicUB = 3 Then 
      bdjstrEduLevel1 = arrData3(0, 1)
      bdjstrEduLevel2 = arrData3(0, 2)
      bdjstrEduLevel3 = arrData3(0, 3)

	  ValuePrint bdjstrEduLevel1 , "bdjstrEduLevel1-38"
	  ValuePrint bdjstrEduLevel2 , "bdjstrEduLevel2-38"
	  ValuePrint bdjstrEduLevel3 , "bdjstrEduLevel3-38"
	  
	    If bdjstrEduLevel1 = 1 and bdjstrEduLevel2 = 2 and bdjstrEduLevel3 = 3   Then 
			strAcademicId3 = -1
	    ...
	    If bdjstrEduLevel1 = 2 and bdjstrEduLevel2 = 3  and bdjstrEduLevel3 = 4  Then 
			strAcademicId1 = "-1"
			strDegreeName1 = "S" 
			strInstitute1 = ""
			strPassingYear1 = "S"
	    ...
	    If bdjstrEduLevel1 = 3 and bdjstrEduLevel2 = 4 and bdjstrEduLevel3 = 5 Then 
		...
		End If 
	    If bdjstrEduLevel1 = 4 and bdjstrEduLevel2 = 5 and bdjstrEduLevel3 = 6 Then 
			strAcademicId1 = "-1"
			strDegreeName1 = "S" 
			strInstitute1 = ""
			strPassingYear1 = "S"
	    ...
	    If bdjstrEduLevel1 = 1 and bdjstrEduLevel2 = 3 and bdjstrEduLevel3 = 4  Then 
		...
		End If 
 	    ...
 	    If bdjstrEduLevel1 = 1 and bdjstrEduLevel2 = 4  and bdjstrEduLevel3 = 5 Then 
			strAcademicId3 = -1
			strDegreeName3 = arrData3(1, 2)
			strInstitute3 = arrData3(3, 2)
			strSubject3 = arrData3(4, 2)
			...
			strAcademicId4 = -1
			strDegreeName4 = arrData3(1, 3)
			strInstitute4 = arrData3(3, 3)
			strSubject4 = arrData3(4, 3)
			strPassingYear4 = arrData3(2, 3)
			strUniversity4 = ""
			strResult4 = arrData3(6, 3)
			strResultPoint4 = arrData3(7, 3)
			strUniversityType4 = arrData3(5, 3)
			If strResultPoint4 <> "" Then 
			  If strResultPoint4 < 5 Then 
				strCGPAScale4 = "4"  ' 000
			  Else
			...
			strEducationId4 = "4"	
			strEduLevel4 = arrData3(0, 3) 
 
		 
        End If 
 

	    If bdjstrEduLevel1 = 1 and bdjstrEduLevel2 = 5 and bdjstrEduLevel3 = 6 Then 
			strAcademicId1 = -1
			strDegreeName1 = arrData3(1, 1)
			strInstitute1 = arrData3(3, 1)
			strSubject1 = arrData3(4, 1)
	    ...
	    If bdjstrEduLevel1 = 2 and bdjstrEduLevel2 = 4  and bdjstrEduLevel3 = 5  Then 
		 ValuePrint bdjstrEduLevel , "GraduationForOneRow"
		 'CALL GraduationForOneRow
			strAcademicId1 = "-1"
			strDegreeName1 = "S" 
		...
		End If 
	    If bdjstrEduLevel1 = 2 and bdjstrEduLevel2 = 5 and bdjstrEduLevel2 = 6 Then 
			strAcademicId1 = "-1"
			strDegreeName1 = "S" 
			strInstitute1 = ""
			strPassingYear1 = "S"
		...
		End IF 
	    If bdjstrEduLevel1 = 3 and bdjstrEduLevel2 = 5 and bdjstrEduLevel3 = 6 Then 
	    ...
	    If bdjstrEduLevel1 = 1 and bdjstrEduLevel2 = 2 and bdjstrEduLevel3 = 5 Then 
			...
			strPassingYear4 = arrData3(2, 3)
			strUniversity4 = ""
			strResult3 = arrData4(6, 3)
			strResultPoint4 = arrData4(7, 3)
			strUniversityType4 = arrData4(5, 3)
			If strResultPoint4 <> "" Then 
			  If strResultPoint4 < 5 Then 
				strCGPAScale4 = "4"  ' 000
			  Else
	    ...
	    If bdjstrEduLevel1 = 1 and bdjstrEduLevel2 = 2 and bdjstrEduLevel3 = 4 Then 
