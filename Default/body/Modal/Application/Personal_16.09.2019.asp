            ...
            <h1 class="post-name">Application for <%=job_position%> </h1>
              ...
              <div class="wrapper">
                  <div class="row vertical-align-items">
                    ...
                    <!--#include virtual = '/applications/common/photo_upload/pre_upload/photo_and_signature_pre_upload.asp' -->
                     ...
                     <div class="row">
                      ...
                      <div class="row">
                           ...
                           <div class="col-sm-6">
                              <div class="form-group">
                                 <div class="row">
                                    <!--include File = 'Personal\ThanaUnderPermanentDistrict.asp' -->                                 </div>
                              </div>
                          </div>
