  <div class="form-group">
                       ...
                       <% if cstr(strFormAction) = cstr("EditResume") then 
					   			'response.Write("i m "&strFormAction)
					   %> 
...
<div class="radio">
<input  type="radio"   name="ddlFFQ" id="ddlFFQY"  value="1"/>Yes</div>
...
<div class="row" id="fredom" style="<%if  strFredomFighterQuestion = 0  Then%>display:none;<%End IF%>">
 ...
 <div class="radio">
  ...
  Child
   ...
   <div class="radio">
<input  type="radio" name="ddlFF" id="ddlFFGC" value="GC" <%if strFredomFighterAnswer = "GC" Then Response.Write("Checked")%> />
    Grand Child
  </div>
                         
</div>
                      
<div class="radio"><input  type="radio" name="ddlFFQ" id="ddlFFQN" value="0" />No</div>                      
