...
<div class="row">
  <div class="col-xs-4">
    <div class="required">
                 <select class="form-control input-sm" name="ddlDateOfBirthDay" id="ddlDateOfBirthDay"   <%If strDateOfBirthDay = "S" And IsBlank = "True" Then%> "background-color:#FFCA95;"<%End If%> onChange="CheckAge('<%=dtmBirthEligible_js%>','30');">
...
<%
		...
		Next
%>
				<select class="form-control input-sm" name="ddlDateOfBirthMonth" id="ddlDateOfBirthMonth"  <%If strDateOfBirthMonth = "S" And IsBlank = "True" Then%> "background-color:#FFCA95;"<%End If%> onChange="CheckAge('<%=dtmBirthEligible_js%>','30');">
  ...
  <div class="col-xs-4">
    <div class="required">
 <select  class="form-control input-sm" name="ddlDateOfBirthYear" id="ddlDateOfBirthYear"  <%If strDateOfBirthYear = "S" And IsBlank = "True" Then%> "background-color:#FFCA95;"<%End If%> onChange="changeEstericColor(this.id);CheckAge('<%=dtmBirthEligible_js%>','30');">
