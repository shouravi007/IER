...
%>
  ...
  <div class="col-sm-8" id="cgpa<%=i%>" style="<%=strVisibilityResultPoint%>">
             ...
             <input class="form-control input-sm" type="text" name="txtResultPoint<%=i%>" id="txtResultPoint<%=i%>" size="3" maxlength="5" style="<%=bgColorResultPoint%>"  value="<%=strResultPoint%>" onKeyPress='return resultPoint(this, event)' placeholder = 'type your cgpa/marks'/>
