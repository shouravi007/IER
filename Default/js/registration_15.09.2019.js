...
//	 }
   ...
   if ( CheckValidation("True",objEmail,"text","Text","50","Email ",1720) == false)
	{
		   return false;		   
	}

   if ( CheckValidation("True",objEmail,"email","Text","50","Email ",1710) == false)
	{
		   return false;		   
	}	
...
function minimum_academic_qualification_ksb()
 {
		  ...
		  {
			ErrorMessage("1247", ex, "1" , "registration.js  :: function ResultChekingForJobPost", system);
		  }
...
function EmptyPassword()
{
	...
	{
				  ErrorMessage("2046", ex, "1" ,url + " ::  registration.js  :: function EmptyPassword", system);
